      ...
      <section className="py-12 bg-gradient-to-r from-blue-500 to-indigo-600 text-white text-center">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <p className="text-lg md:text-xl max-w-2xl mx-auto mb-6">
            Google OAuth and Webhook integration support. More API integrations
            may be added in the future, further enriching your experience.
          </p>
      ...
      <section className="py-12">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <p className="text-gray-600 dark:text-gray-300 mb-6 max-w-xl mx-auto text-center">
            Our integration system connects your wallet to other platforms, providing more convenience.
          </p>
        </div>
      </section>
    </div>
