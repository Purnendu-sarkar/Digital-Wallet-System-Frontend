      ...
      <section className="py-12 bg-gradient-to-r from-blue-500 to-indigo-600 text-white text-center">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <p className="text-lg md:text-xl max-w-2xl mx-auto mb-6">
            Visualize your transaction history and spending trends. Admins can filter and analyze all transactions.
          </p>
      ...
      <section className="py-12">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <p className="text-gray-600 dark:text-gray-300 mb-6 max-w-xl mx-auto text-center">
            Easily understand your financial data and make decisions with our analytics tools.
          </p>
        </div>
      </section>
    </div>
